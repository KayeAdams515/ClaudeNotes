...
> [!warning] Remark（课本原文）：避免使用 "for any $x$"
...
## 10. Lewis Carroll 的例子 Examples from Lewis Carroll
...
## 11. 逻辑程序设计 Logic Programming（Prolog）
...
> [!example] 习题 29｜用量词表达关于命题本身的陈述（元层面）
...
> [!question] 4. 论域为空时，$\forall x P(x)$ 与 $\exists x P(x)$ 的真值分别是什么？
...
> [!question] 15. Prolog 中的 `,` 和 `:-` 分别是什么意思？规则体中独有的变量被什么量词约束？
