...
> 课件用一整页贴了手机、步进电机、硬盘、风力发电机、微波炉、磁悬浮/高铁、话筒、过山车、天线、集成电路板、扬声器、冰箱贴、磁性传感器、卫星、金属晶格模型共 15 张图。老师讲的意思是：**这一整册电磁学不是抽象数学，上面每一件东西的工作原理都要用到接下来 12 章的内容**——扬声器/话筒是安培力与电磁感应（Ch28/30），硬盘是磁化与磁记录（Ch28），微波炉是电磁波（Ch32），电路板是电流、电阻、电容与电路（Ch25–27），磁悬浮是感应涡流。图本身不含公式，不必背，理解"电磁学 = 现代电子技术的底层"即可。
