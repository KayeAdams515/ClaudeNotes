...
source: SCUT 未来技术学院 · Ya-Hui Jia（第1–3章课件 + 第一/第二节课授课转写稿；Stack 无对应转写稿）
---
...
> 第 2 章按现有记录尚未开课，暂不做逐条标注；第 3 章 Stack 已按课件整理为一篇全章讲义，但没有对应转写稿，实际授课进度待核实。各篇开头有「授课进度说明」或来源说明，补充推导不冒充课堂原话。
...
> - 第 3 章 Stack：课件 p.1–103 已完整整理为 [[C3.1 栈 Stack]]；尚无本章转写稿，实际授课进度待核实。第 4 章 Queue 待整理，两者与 List 属于同一 Linear Structure 框架。

---

*课件来源：`pdfs/第1章：绪论.pdf`、`pdfs/第2章：线性表.pdf`、`pdfs/3.02.Stacks.pdf`*
