...
## 3. 把量化看成嵌套循环 Thinking of Quantification as Loops
...
> [!example] 习题 62（§1.4 末尾的 Lewis Carroll 题）｜鸭子与军官
...
> [!question] 7. 写出极限 $\lim_{x\to a} f(x) = L$ 的量词定义，并说明为什么量词顺序不能改。
